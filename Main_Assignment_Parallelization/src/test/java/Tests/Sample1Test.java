...
public class Sample1Test extends SampleTest{
        ...
        public static void bm_login() throws InterruptedException, IOException {
            ...
            Thread.sleep(3000);
            SampleTest.driver.findElement(By.xpath("//*[@placeholder='First Name']")).sendKeys("Sahana");
            SampleTest.driver.findElement(By.xpath("//*[@placeholder='Last Name']")).sendKeys("KH");
            SampleTest.driver.findElement(By.xpath("//*[@placeholder='Post Code']")).sendKeys("560010");
            Thread.sleep(2000);
